        ...
        <div class="table-responsive">
            <form action="vnpay_create_payment.php" id="create_form" method="post">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control" id="order_id" name="order_id" readonly type="text"
                        value="<?php echo date(" YmdHis") ?>"/>
                </div>
                <div class="form-group">
                    <label for="amount">Số tiền</label>
                    <input class="form-control" id="amount" name="amount" readonly type="number" value="1000000" />
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control" id="txtexpire" readonly name="txtexpire" type="text"
