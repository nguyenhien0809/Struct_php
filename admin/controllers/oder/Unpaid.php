        ...
        public function __construct()
        {
            ...
            switch ($act) {
                ...
                case 'select':
                    ...
                    $data = $this->Model->fetch("select * from don_hang where Thanh_Toan = 1 order by Thoi_Gian_DH desc limit $sl");
                break;  
                default:
                    $data = $this->Model->fetch("SELECT * from don_hang where Thanh_Toan = 1 order by Thoi_Gian_DH desc limit 25");
                break;
            }
